...
#ifndef _Vkpu_sram__D5_W20_H_
#define _Vkpu_sram__D5_W20_H_
...
VL_MODULE(Vkpu_sram__D5_W20) {
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vkpu_sram__D5_W20);  ///< Copying not allowed
  public:
    Vkpu_sram__D5_W20(const char* name="TOP");
    ~Vkpu_sram__D5_W20();
  ...
  public:
    static void _sequent__TOP__kpu__regs__registers__1(Vkpu__Syms* __restrict vlSymsp);
} VL_ATTR_ALIGNED(128);
