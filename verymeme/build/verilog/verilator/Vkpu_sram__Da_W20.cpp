...
VL_CTOR_IMP(Vkpu_sram__Da_W20) {
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void Vkpu_sram__Da_W20::__Vconfigure(Vkpu__Syms* vlSymsp, bool first) {
    if (0 && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
}

Vkpu_sram__Da_W20::~Vkpu_sram__Da_W20() {
}

//--------------------
// Internal Methods

VL_INLINE_OPT void Vkpu_sram__Da_W20::_sequent__TOP__kpu__mmu__ram__1(Vkpu__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vkpu_sram__Da_W20::_sequent__TOP__kpu__mmu__ram__1\n"); );
    ...
    __Vdlyvdim0__mem__v0 = (0x3ffU & vlSymsp->TOP__kpu.tmp0_val);
    // ALWAYSPOST at sram.v:16
    vlSymsp->TOP__kpu__mmu__ram.mem[__Vdlyvdim0__mem__v0] 
	= __Vdlyvval__mem__v0;
}

void Vkpu_sram__Da_W20::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vkpu_sram__Da_W20::_ctor_var_reset\n"); );
    // Body
